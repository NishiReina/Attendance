    ...
    <form class="detail__form" action="/attendance/{{$attendance->id}}" method="post">
        ...
        <table class="detail__table">
            ...
            <tr class="detail__tr">
                ...
                <td class="detail__td"><input name="start_time" type="time" value="{{MyFunc::time_format($attendance->start_time)}}"></td>
                <td class="detail__td"><input name="end_time" type="time" value="{{MyFunc::time_format($attendance->end_time)}}"></td>
            </tr>
